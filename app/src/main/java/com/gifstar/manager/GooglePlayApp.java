...
public class GooglePlayApp {
    ...
    public static boolean isInstalledMessenger(Context context, String packageName) {
        PACKAGE_NAME = packageName;
        if (!hasMessengerInstalled(context)) {
    ...
    private static void openMessengerInPlayStore(Context context) {
        try {
